...
class Eventbrite(AccessMethodsMixin):
    ...
    def delete_ticket_class(self, event_id, ticket_class_id):
        return self.delete("/events/{0}/ticket_classes/{1}/".format(event_id, ticket_class_id))

    def post_ticket_class(
            self, event_id,
            name = None,
            quantity_total = None,
            cost = None,
    ...
    "event": {
        ...
        return self.post("/organizations/{0}/events/".format('280325553405'), data=data)
